...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&duration=3000&pause=1000&color=70A5FD&center=true&vCenter=true&width=750&lines=Hi%2C+I'm+Ruthra+G+%F0%9F%91%8B;Full-Stack+Developer+%7C+Android+%2B+Web;Kotlin+%7C+Flutter+%7C+Node.js+%7C+Firebase;Building+apps+that+actually+matter+%F0%9F%9A%80" alt="Typing SVG"/>
...
class Ruthra:
    ...
    fun_fact = "I built a Random Forest ML model 🌳 inside an Android app!"

    def motto(self):
        return "Ship fast. Test well. Learn always. 🚀"
```
...
![Firebase Realtime DB](https://img.shields.io/badge/Firebase_DB-FF6F00?style=flat-square&logo=firebase&logoColor=white)
...
<details>
<summary><strong>🏢 Pragathi Interiors — Web Development Intern | Jun 2025 · 1 Month | Puducherry, India</strong></summary>
...
- Developed responsive front-end components using HTML, CSS, and JavaScript across the full web development lifecycle.
- Integrated client-side scripting for dynamic content rendering, enhancing UI interactivity.
- Collaborated on delivering production-ready web pages aligned to client design requirements.
...
```
🐦 Flutter        →  Widgets · State Management (Provider/Riverpod) · Animations
🟢 Node.js        →  Express · REST APIs · Auth · JWT
🏗️  NestJS         →  Modules · Guards · Pipes · Decorators
☁️  AWS            →  EC2 · S3 · Lambda · IAM · Deployment
🗄️  Databases      →  MySQL advanced · MongoDB aggregation
🧪 Testing        →  Unit Testing · Integration Testing · Flutter widget tests
```
